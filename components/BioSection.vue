...
const content = "I'm currently a student in the University of Waterloo studying Computer Science. Coffee lover and data enthusiast."
</script>
        ...
        <div class="flex flex-row md:basis-1/2 items-center">
            <NuxtLink to="/about">
                <div class="w-10 h-10 mx-3">
                    <img src="/public/cover.jpg" alt="Cover" class="rounded-full w-10 h-10"/>
                </div>
            </NuxtLink>
