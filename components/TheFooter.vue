<template>
  <div class="grid grid-cols-1 md:grid-cols-2 pt-6 pb-12 px-16 md:mx-12 items-start text-gray-700 dark:text-gray-200">
    <div class="basis-1/2 flex-col px-6 py-6">
      <div>
